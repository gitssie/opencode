...
// schemas (Phase B3/B4). This single schema replaces the historical SQLite
// migrations. Regenerate with: bunx drizzle-kit generate (using drizzle.config.ts;
// do NOT pass --schema CLI flags — that path drops tables) and re-squash here.
