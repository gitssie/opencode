...
export const defaultLayer = Layer.suspend(() =>
  layer
    .pipe(
      ...
      // Sandbox: wrap the process spawner so child processes (shell tool, etc.)
      // run inside zerobox/bwrap isolation. Same ChildProcessSpawner service tag
      // as upstream's CrossSpawnSpawner.defaultLayer; SandboxSpawner.layer
      // provides CrossSpawnSpawner.defaultLayer internally.
