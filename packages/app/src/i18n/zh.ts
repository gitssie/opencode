...
export const dict = {
  ...
  "session.new.title": "今天想构建什么？",
  "session.new.subtitle": "让我帮你写代码、修复 Bug、解释概念，或应对任何工程挑战。",
  ...
  "settings.mcp.status.needs_auth": "需要授权",
  "settings.mcp.status.needs_client_registration": "需要注册",
  "settings.mcp.add.button": "添加服务器",
  "settings.mcp.add.title": "添加 MCP 服务器",
  "settings.mcp.add.type.local": "本地（stdio）",
  "settings.mcp.add.type.remote": "远程（HTTP）",
  "settings.mcp.add.name.label": "名称",
  "settings.mcp.add.name.placeholder": "my-server",
  "settings.mcp.add.name.required": "名称不能为空",
  "settings.mcp.add.command.label": "命令",
  "settings.mcp.add.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.add.command.required": "命令不能为空",
  "settings.mcp.add.command.browse": "浏览...",
  "settings.mcp.add.url.label": "URL",
  "settings.mcp.add.url.placeholder": "https://example.com/mcp",
  "settings.mcp.add.url.required": "URL 不能为空",

  "toast.mcp.connected.title": "已连接",
  "toast.mcp.connected.description": "已连接到 {{name}}",
  "toast.mcp.disconnected.title": "已断开",
  "toast.mcp.disconnected.description": "已断开 {{name}} 的连接",

  "settings.agents.empty": "未找到 Agent",
  "settings.agents.search.placeholder": "搜索 Agent...",
  "settings.agents.source.native": "内置",
  "settings.agents.source.config": "配置",
  "settings.agents.tag.hidden": "已隐藏",
  "settings.agents.mode.primary": "主 Agent",
  "settings.agents.mode.subagent": "子 Agent",
  "settings.agents.mode.all": "全部",
  "settings.agents.create.button": "新建 Agent",
  "settings.agents.detail.color": "颜色",
  "settings.agents.detail.model": "模型",
  "settings.agents.detail.model.inherited": "继承全局设置",
  "settings.agents.detail.prompt": "系统提示词",
  "settings.agents.form.create.title": "新建 Agent",
  "settings.agents.form.edit.title": "编辑 Agent",
  "settings.agents.form.name.label": "名称",
  "settings.agents.form.name.placeholder": "my-agent",
  "settings.agents.form.name.required": "名称不能为空",
  "settings.agents.form.name.invalid": "名称只能包含字母、数字和中横线",
  "settings.agents.form.name.duplicate": "已存在同名 Agent",
  "settings.agents.form.description.label": "描述",
  "settings.agents.form.description.placeholder": "描述此 Agent 的用途",
  "settings.agents.form.mode.label": "模式",
  "settings.agents.form.prompt.label": "系统提示词",
  "settings.agents.form.prompt.placeholder": "你是一个有帮助的助手...",
  "settings.agents.form.color.label": "颜色",
  "settings.agents.form.hidden.label": "在 Agent 选择器中隐藏",
  "settings.agents.form.delete.confirm": "再次点击确认删除",

  "toast.agents.saved.title": "Agent 已保存",
  "toast.agents.deleted.title": "Agent 已删除",

  "sidebar.section.projects": "项目",
  "sidebar.section.skills": "技能",
  "sidebar.section.tasks": "任务",
  "sidebar.projects.empty": "没有打开的项目",
  "sidebar.tasks.empty": "暂无会话",
  "sidebar.tasks.no_project": "打开项目后查看会话",
  "sidebar.skills.count": "已安装 {{count}} 个技能",

  "settings.skills.title": "技能",
  "settings.skills.empty": "未安装技能",
  ...
  "settings.skills.tab.browse": "浏览 Hub",
  "settings.skills.install.success": "技能已安装",
  "settings.skills.browse.search": "搜索技能...",
  "settings.skills.browse.searchButton": "搜索",
  "settings.skills.browse.empty": "未找到技能",
  "settings.skills.browse.installed": "已安装",
  "settings.skills.browse.install": "安装",
  "settings.skills.browse.page": "第 {{page}} 页",
  "settings.skills.browse.next": "下一页",
  "settings.skills.browse.desktopOnly": "浏览技能库仅在桌面应用中可用。",
