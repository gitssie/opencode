export const dict = {
  ...
  "session.new.title": "What can I help you build?",
  "session.new.subtitle": "Ask me to write code, fix bugs, explain concepts, or tackle any engineering challenge.",
  ...
  "common.openDirectory": "Open directory",
  "common.deleting": "Deleting...",

  "settings.section.manage": "Manage",
  ...
  "settings.mcp.status.needs_client_registration": "Needs Registration",
  "settings.mcp.add.button": "Add Server",
  "settings.mcp.add.title": "Add MCP Server",
  "settings.mcp.add.type.local": "Local (stdio)",
  "settings.mcp.add.type.remote": "Remote (HTTP)",
  "settings.mcp.add.name.label": "Name",
  "settings.mcp.add.name.placeholder": "my-server",
  "settings.mcp.add.name.required": "Name is required",
  "settings.mcp.add.command.label": "Command",
  "settings.mcp.add.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.add.command.required": "Command is required",
  "settings.mcp.add.command.browse": "Browse...",
  "settings.mcp.add.url.label": "URL",
  "settings.mcp.add.url.placeholder": "https://example.com/mcp",
  "settings.mcp.add.url.required": "URL is required",
  ...
  "toast.mcp.disconnected.description": "Disconnected from {{name}}",

  "settings.agents.empty": "No agents found",
  "settings.agents.search.placeholder": "Search agents...",
  "settings.agents.source.native": "Built-in",
  "settings.agents.source.config": "Config",
  "settings.agents.tag.hidden": "Hidden",
  "settings.agents.mode.primary": "Primary",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.mode.all": "All",
  "settings.agents.create.button": "New Agent",
  "settings.agents.detail.color": "Color",
  "settings.agents.detail.model": "Model",
  "settings.agents.detail.model.inherited": "Inherited from global settings",
  "settings.agents.detail.prompt": "System Prompt",
  "settings.agents.form.create.title": "New Agent",
  "settings.agents.form.edit.title": "Edit Agent",
  "settings.agents.form.name.label": "Name",
  "settings.agents.form.name.placeholder": "my-agent",
  "settings.agents.form.name.required": "Name is required",
  "settings.agents.form.name.invalid": "Name may only contain letters, numbers, and hyphens",
  "settings.agents.form.name.duplicate": "An agent with this name already exists",
  "settings.agents.form.description.label": "Description",
  "settings.agents.form.description.placeholder": "Describe what this agent does",
  "settings.agents.form.mode.label": "Mode",
  "settings.agents.form.prompt.label": "System Prompt",
  "settings.agents.form.prompt.placeholder": "You are a helpful assistant...",
  "settings.agents.form.color.label": "Color",
  "settings.agents.form.hidden.label": "Hide from agent selector",
  "settings.agents.form.delete.confirm": "Click again to confirm delete",

  "toast.agents.saved.title": "Agent saved",
  "toast.agents.deleted.title": "Agent deleted",

  "sidebar.section.projects": "Projects",
  "sidebar.section.skills": "Skills",
  "sidebar.section.tasks": "Tasks",
  "sidebar.projects.empty": "No projects open",
  "sidebar.tasks.empty": "No sessions yet",
  "sidebar.tasks.no_project": "Open a project to see sessions",
  ...
  "settings.skills.source.hub": "Hub",
  "settings.skills.tab.installed": "Installed",
  "settings.skills.tab.browse": "Browse Hub",
  "settings.skills.install.success": "Skill installed",
  "settings.skills.browse.search": "Search skills...",
  "settings.skills.browse.searchButton": "Search",
  "settings.skills.browse.empty": "No skills found",
  "settings.skills.browse.installed": "Installed",
  "settings.skills.browse.install": "Install",
  "settings.skills.browse.page": "Page {{page}}",
  "settings.skills.browse.next": "Next",
  "settings.skills.browse.desktopOnly": "Browsing the skills hub is only available in the desktop app.",
}
